  ...
  if (events.length === 0) {
    return (
      <div className="py-16 text-center">
        <div className="relative mx-auto max-w-2xl overflow-hidden rounded-2xl bg-card/40 border border-border/50 backdrop-blur-xl p-8 lg:p-12 shadow-[0_8px_30px_rgb(0,0,0,0.12)]">
          <div className="mx-auto max-w-md space-y-6">
            <div className="mx-auto w-fit rounded-full bg-primary/10 p-4 shadow-[0_0_15px_rgba(0,118,255,0.2)]">
              <Calendar className="h-12 w-12 text-primary" />
            </div>
            <div className="space-y-2">
              <h2 className="bg-gradient-to-br from-foreground via-foreground/90 to-muted-foreground bg-clip-text text-2xl font-bold text-transparent">No Events Yet</h2>
  ...
  return (
    <div className="space-y-16">
      ...
      {active.length > 0 && (
        <section className="space-y-6">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-3xl font-bold tracking-tight bg-gradient-to-br from-foreground to-muted-foreground bg-clip-text text-transparent">Live Now</h2>
          </div>
      ...
      {upcoming.length > 0 && (
        <section className="space-y-6">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-2xl font-bold tracking-tight bg-gradient-to-br from-foreground to-muted-foreground bg-clip-text text-transparent">On The Horizon</h2>
          </div>
          <div className="grid grid-cols-1 gap-6 xl:grid-cols-2">
            {upcoming.map(ed => (
              <EventCard
      ...
      {past.length > 0 && (
        <section className="space-y-6">
          <div className="flex items-center gap-3">
            <div className="rounded-xl bg-muted p-2.5 border border-border/50">
              <Archive className="h-6 w-6 text-muted-foreground" aria-hidden="true" />
            </div>
            <h2 className="text-2xl font-bold tracking-tight bg-gradient-to-br from-foreground to-muted-foreground bg-clip-text text-transparent">The Archive</h2>
          </div>
