...
export function SuperAdminMemberRemoveModal({
  member,
  clanId,
  isOwner,
  isLastAdmin,
}: SuperAdminMemberRemoveModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (isOwner) {
      toast({
        ...
        description:
          "The clan owner cannot be removed. Transfer ownership first.",
        variant: "destructive",
      })
      return
    }
      ...
      <DialogContent className="max-w-md">
        ...
        {isOwner ? (
          <Alert variant="destructive">
            ...
            <AlertDescription>
              The clan owner cannot be removed from the clan. You must transfer
              ownership to another member first using the Edit Clan modal.
            </AlertDescription>
          </Alert>
        ) : (
          <>
            {isLastAdmin && (
              <Alert className="border-orange-200 bg-orange-50 dark:border-orange-800 dark:bg-orange-950/20">
                ...
                <AlertDescription className="text-orange-700 dark:text-orange-300">
                  Warning: This is the last admin in the clan. Removing them
                  will leave the clan without any administrators.
                </AlertDescription>
              </Alert>
            )}
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="flex items-start gap-2">
                ...
                >
                  I understand this will permanently remove {displayName} from
                  the clan
                </Label>
              </div>
              ...
              <div className="flex justify-end gap-2">
                ...
                <Button
                  type="submit"
                  variant="destructive"
                  disabled={loading || !confirmed || isOwner}
                >
