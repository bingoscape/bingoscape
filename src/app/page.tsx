        ...
        {session ? (
          ...
          <div className="flex flex-col lg:flex-row gap-12 items-start justify-between py-12">
            <div className="space-y-8 max-w-xl">
              <h1 className="text-5xl font-bold text-white">BingoScape</h1>

              <p className="text-lg text-[#677da2]">
                BingoScape Companion is a powerful RuneLite plugin that seamlessly integrates with the BingoScape
                platform, making it easier than ever to participate in bingo events. Connect to events, track your
                progress, submit evidence, and collaborate with your team—all within the RuneLite client.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-8">
                <a
                  ...
                  className="bg-[#101828] p-6 rounded-lg text-center flex flex-col items-center hover:bg-[#1e293b] transition-colors"
                >
                  ...
                  <p className="text-sm text-[#677da2]">Contact us for support, feedback or leave toy ideas</p>
                </a>
                ...
                >
                  ...
                  <p className="text-sm text-[#677da2]">Download the RuneLite plugin and start playing</p>
                </a>
                ...
                >
                  ...
                  <p className="text-sm text-[#677da2]">Create or participate in an event or bingo</p>
                </Link>
              </div>
            </div>

            <div className="w-full lg:w-1/2 mt-8 lg:mt-0">
              <div className="bg-[#101828] rounded-lg p-4 w-full max-w-xl mx-auto">
