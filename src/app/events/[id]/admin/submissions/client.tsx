...
export function ReviewSubmissionsClient({ teamTileSubmissions, teams, isSubmissionsLocked }: ReviewSubmissionsClientProps) {
        ...
        <>
            <SubmissionsTab
                ...
                onSubmissionStatusUpdate={async (id, status, goalId, submissionValue) => {
                    ...
                    if (goalId !== undefined) {
                        await updateSubmissionGoalAndValue(id, goalId, submissionValue ?? 1.0);
                    }
                }}
