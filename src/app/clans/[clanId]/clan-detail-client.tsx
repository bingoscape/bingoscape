...
export function ClanDetailClient({
  ...
  const handleRoleUpdate = async (memberId: string, newRole: Role) => {
    try {
      await updateMemberRole(clanId, memberId, newRole)
      const updatedMembers = await getClanMembers(clanId)
        ...
        <CardHeader className="pb-4">
          <div className="flex items-start justify-between">
            ...
            <div className="flex space-x-2">
                  ...
                  <SheetContent className="w-full overflow-y-auto sm:max-w-4xl">
                    ...
                    <div className="space-y-6 py-6">
                      ...
                      <Card>
                        ...
                        <CardContent>
                          <GenerateClanInviteLink clanId={clanId} />
                        </CardContent>
                      </Card>
                      ...
                      <Card>
                        ...
                        <CardContent>
                          <ClanInvitesManagement clanId={clanId} />
                        </CardContent>
                      </Card>
                    </div>
                  </SheetContent>
              ...
              <Link href={`/clans/${clanId}/events`} passHref>
                <Button variant="outline">
              ...
              <div>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm font-semibold">
                    {clanDetails.owner?.runescapeName ?? "Unknown Player"}
                  </span>
                </div>
              </div>
            </div>
